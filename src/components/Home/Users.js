...
import AdminNav from './TechAdminNav.js';
    ...
    <tr key={item.id}>
      ...
      <td>
        <button onClick={() => DeleteUser(item.id)} className="btn text-warning">
          <i className="bi bi-pen">delete</i>
        </button>
      </td>
    </tr>
  );
          ...
          <table className=' table table-sm m-2 mb-5 text-center table-responsive'>
            <thead>
              ...
              <tr className='table-header'>
                ...
                <th style={{ backgroundColor: '#eaeaea', color: '#333333' }}>Block</th>
                <th style={{ backgroundColor: '#eaeaea', color: '#333333' }}>Floor</th>
                <th style={{ backgroundColor: '#eaeaea', color: '#333333' }}>Room No</th>
                <th style={{ backgroundColor: '#eaeaea', color: '#333333' }}>Delete</th>
              </tr>
