...
const CivilAdminNav = ({id, floor, block, room}) => {
  console.log(floor)
  return (
    <>
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className='navbar-nav'>
            ...
            <h2 style={{color:"white"}}>Civil Admin</h2>
          {/* <li className="nav-item"><NavLink to='/users' className='nav-link' state={{ id:{id}, floor:{floor}, block:{block}, room:{room} }}>Users</NavLink> </li>
            <li className="nav-item"><NavLink to='/civil-complaints' className='nav-link'state={{ id:{id}, floor:{floor}, block:{block}, room:{room} }}>Complaints</NavLink> </li> */}
