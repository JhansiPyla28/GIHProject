...
export const FetchComplaints = ({ userid, handleShow, handleShowImg }) => {
  ...
  const filteredComplaints = complaints.filter(item => item.type === 'Technical');
  const revComplaints = [...filteredComplaints].reverse();
...
const TechComplaints = ({id, room, floor, block}) => {
    ...
    <MainAdminNav/>
      <section className='complaints w-100' style={{ minHeight: '500px' }}>
        <div className='container'>
          <h3 className='text-center m-2 p-3'>Technical Complaints</h3>
