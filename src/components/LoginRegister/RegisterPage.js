...
const RegisterPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const userIdRegex = /^[N](18|19|20|21|22|23)\d{4}$/;
    if (!userIdRegex.test(userId)) {
      alert("Invalid User ID format. Please use your college ID");
      return;
    }
    ...
    if (!passwordRegex.test(password)) {
      alert("Invalid Password format. Password should be at least 8 characters long, start with a capital letter, and contain at least one number and one special character.");
      return;
    }

    // Validate email format
    const emailRegex = new RegExp(`^n(18|19|20|21|22|23)\\d{4}@rguktn.ac.in$`, 'i');
    if (!emailRegex.test(email)) {
      alert("Invalid Email format. Please register with you college mail");
      return;
    }
      ...
      <div className="register-form p-4 border rounded">
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3" controlId="formPhoneNumber">
            ...
            <Form.Control type="tel" placeholder="Enter your phone number" value={phoneNumber} onChange={handlePhoneNumberChange} />
          </Form.Group>
          ...
          <Button type="submit" className="w-100 register">
            Register
          </Button>
          <div className='pt-2'>
